...
1. **ขนาดของสถานที่:** ในแต่ละวันจะมีการสุ่มจำนวนสถานที่ให้ตกอยู่ในช่วง `min_places_per_day` ถึง `max_places_per_day` (เช่น 5 ถึง 7 แห่ง)
2. **การบังคับประเภทสถานที่:** แต่ละวันจะถูกบังคับให้สุ่มเลือกสถานที่ประเภทผลิตภัณฑ์ชุมชน (OTOP) จำนวน 1 แห่ง และร้านอาหาร (Food หรือ Food and Café) จำนวน 1 แห่ง บรรจุลงไปในลิสต์ของวันนั้นๆ อย่างแน่นอน
...
$$ Z = W_d \left(\frac{F_{dist}}{250}\right) + W_{co2} \left(\frac{F_{co2}}{200}\right) + W_r (1.0 - F_{rating}) + \mathcal{P} $$

โดยที่:
* $F_{dist}$ คือ ระยะทางรวมทั้งหมด (กิโลเมตร)
* $F_{co2}$ คือ ปริมาณก๊าซคาร์บอนไดออกไซด์รวม (กิโลกรัม)
* $F_{rating}$ คือ คะแนนความนิยมรวมแบบสะสม (Collective Rating Score) คำนวณจากผลรวมเรตติ้งหารด้วยคะแนนสูงสุดที่เป็นไปได้ตามความจุของทริป
